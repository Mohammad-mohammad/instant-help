...
class Competence extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'competenceHasClients' => array(self::HAS_MANY, 'CompetenceHasClient', 'competence_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => Yii::t('tx', 'ID'),
			'name' => Yii::t('tx', 'Name'),
			'description' => Yii::t('tx', 'Description'),
		);
	}
    ...
    public function getUrl() {
        return Yii::app()->createUrl('Competence/view', array('id' => $this->id));
    }
    public function getA_Url() {
        return Yii::app()->createAbsoluteUrl('Competence/view', array('id' => $this->id));
    }
