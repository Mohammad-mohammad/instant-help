...
class CallingController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Calling'];
            if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Calling');
	...
	{
		$model=new Calling('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Calling']))
			$model->attributes=$_GET['Calling'];
	...
	{
		$model=Calling::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='calling-form')
		{
