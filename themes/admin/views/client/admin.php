...
?>
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'Manage');echo " "; echo Yii::t('tx', 'Clients'); ?></h2>
...
<div class="x_content" style="display: block;">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php $this->widget('bootstrap.widgets.TbGridView',array(
                ...
                'columns'=>array(
					...
					array(
                        'name' => 'photo',
                        'type' => 'HTML',
                        'value' => 'Helpers::thumb($data->absolutephoto)',
                        'filter' => false,
                        'sortable' => false,
                    ),
					'country',
					...
					array(
                        'name'=>'clientStatus',
                        'value'=>'Helpers::clientstatus($data->clientStatus)',
                        'type'=>'raw',
                        'filter' =>Helpers::clientstatus(),
                    ),
                    array(
                        'name' => 'level',
                        'headerHtmlOptions' => array('style' => 'width: 60px'),
					...
					/*array(
                        'name' => 'available',
                        'type' => 'html',
                        'value' => 'Helpers::booleanAsIcon($data, "available")',
                        'filter' => array('1' => Yii::t('tx', 'yes'), '0' => Yii::t('tx', 'no')),
                        'headerHtmlOptions' => array('style' => 'width:60px;'),
                    ),*/
					array(
                        'name'=>'clientType',
                        'value'=>'Helpers::clienttype($data->clientType)',
                        'type'=>'raw',
                        'filter' =>Helpers::clienttype(),
                    ),
					//'bankaccount',
                    array(
                        'class'=>'CButtonColumn',
                        ...
                        'buttons'=>array
                        (
                            'delete' => array('visible'=>'Yii::app()->user->checkAccess(\'client.delete\')'),
                            'update' => array('visible'=>'Yii::app()->user->checkAccess(\'client.update\')'),
                            'view' => array('visible'=>'Yii::app()->user->checkAccess(\'client.view\')'),
                        ),
                ),
                ),
            )); ?>
            ...
            <?php if(Yii::app()->user->checkAccess('client.ajaxupdate')): ?>
            <div class="actions">
                <?php echo CHtml::ajaxSubmitButton('Filter',array('ajaxupdate'), array(),array("style"=>"display:none;")); ?>
                <?php echo CHtml::ajaxSubmitButton(Yii::t('tx', 'available').': '.Yii::t('tx', 'yes'),array('ajaxupdate','act'=>'doyes'), array('success'=>'reloadGrid'),array('class'=>'btn default green-stripe mini')); ?>&nbsp;
				<?php echo CHtml::ajaxSubmitButton(Yii::t('tx', 'available').': '.Yii::t('tx', '-no'),array('ajaxupdate','act'=>'doIn-no'), array('success'=>'reloadGrid'),array('class'=>'btn default red-stripe mini')); ?>&nbsp;
