...
$tt= "$('#language-has-client-btn').click(function() { var btn = $(this); btn.html('".$btn_txt."'); });" ;
Yii::app()->clientScript->registerScript('loading',$tt,  CClientScript::POS_END);
?><?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'language-has-client-form',
	...
	<div class="form-group">
        <?php echo $form->labelEx($model, 'language_id',array('class'=>'control-label col-md-2 col-sm-2 col-xs-12')); ?>
    ...
    <div class="form-group">
        <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
            ...
            <?php $this->widget('bootstrap.widgets.TbButton', array(
                ...
                'htmlOptions' => array('id' => 'language-has-client-btn', 'class' => 'lightslategrey')
		    )); ?>
        </div>
    </div>
