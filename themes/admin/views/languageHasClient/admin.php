...
$this->menu=array(
	array('label'=>'List LanguageHasClient','url'=>array('index')),
	array('label'=>'Create LanguageHasClient','url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('language-has-client-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'Manage');echo " "; echo Yii::t('tx', 'Language Has Clients'); ?></h2>
    <ul class="nav navbar-<?php echo Yii::app()->getLanguage()=="ar"?"left":"right"; ?> panel_toolbox">
        ...
        <a href="<?php echo $this->createUrl('create'); ?>" class="btn lightslategrey mini"><i class="icon-plus"></i> <?php echo Yii::t('tx', 'Add');echo " "; echo Yii::t('tx', 'Language Has Client'); ?></a>
        <?php endif; ?>
    </ul>
...
<div class="x_content" style="display: block;">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php $this->widget('bootstrap.widgets.TbGridView',array(
                ...
                'columns'=>array(
                    ...
                    array(
                        ...
                        'buttons'=>array
                        (
                            'delete' => array('visible'=>'Yii::app()->user->checkAccess(\'languagehasclient.delete\')'),
                            'update' => array('visible'=>'Yii::app()->user->checkAccess(\'languagehasclient.update\')'),
                            'view' => array('visible'=>'Yii::app()->user->checkAccess(\'languagehasclient.view\')'),
                        ),
                ),
                ),
            )); ?>
            ...
            <?php if(Yii::app()->user->checkAccess('languagehasclient.ajaxupdate')): ?>
            <div class="actions">
