...
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'Update'); ?> <?php echo Yii::t('tx', 'User'); ?> #<?php echo $model->id; ?></h2>
    <ul class="nav navbar-<?php echo Yii::app()->getLanguage()=="ar"?"left":"right"; ?> panel_toolbox">
        <?php if(Yii::app()->user->checkAccess('user.admin')): ?>
            <a href="<?php echo $this->createUrl('admin'); ?>" class="btn purple mini"><i class="icon-table"></i> <?php echo Yii::t('tx', 'Manage');echo " "; echo Yii::t('tx', 'User'); ?></a>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if(Yii::app()->user->checkAccess('user.view')): ?>
