...
$this->menu=array(
	array('label'=>'List Calling','url'=>array('index')),
	array('label'=>'Create Calling','url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('calling-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'Manage');echo " "; echo Yii::t('tx', 'Callings'); ?></h2>
...
array(
                    ...
                    array(
                        ...
                        'buttons'=>array
                        (
                            'delete' => array('visible'=>'Yii::app()->user->checkAccess(\'calling.delete\')'),
                            'update' => array('visible'=>'Yii::app()->user->checkAccess(\'calling.update\')'),
                            'view' => array('visible'=>'Yii::app()->user->checkAccess(\'calling.view\')'),
                        ),
                ),
                ),
            )); ?>
...
$('#datepicker_for_strat').datepicker({'dateFormat':'yy-mm-dd','changeMonth':'true','changeYear':'true','showButtonPanel':'true','constrainInput':'false','duration':'fast','showAnim':'slide'});
$('#datepicker_for_end').datepicker({'dateFormat':'yy-mm-dd','changeMonth':'true','changeYear':'true','showButtonPanel':'true','constrainInput':'false','duration':'fast','showAnim':'slide'});
}
            ");
            ?>
            <script>
            ...
            <?php if(Yii::app()->user->checkAccess('calling.ajaxupdate')): ?>
            <div class="actions">
