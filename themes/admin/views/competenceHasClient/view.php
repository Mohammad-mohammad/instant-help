...
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'View'); ?> <?php echo Yii::t('tx', 'CompetenceHasClient'); ?> #<?php echo $model->id; ?></h2>
    <ul class="nav navbar-<?php echo Yii::app()->getLanguage()=="ar"?"left":"right"; ?> panel_toolbox">
        ...
        <a href="<?php echo $this->createUrl('create'); ?>" class="btn lightslategrey mini"><i class="icon-plus"></i> <?php echo Yii::t('tx', 'Add');echo " "; echo Yii::t('tx', 'CompetenceHasClient'); ?></a>
        <?php endif; ?>
        <?php if(Yii::app()->user->checkAccess('competencehasclient.update')): ?>
        ...
        <?php endif; ?>
        <?php if(Yii::app()->user->checkAccess('competencehasclient.delete')): ?>
