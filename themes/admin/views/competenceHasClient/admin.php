...
$this->menu=array(
	array('label'=>'List CompetenceHasClient','url'=>array('index')),
	array('label'=>'Create CompetenceHasClient','url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('competence-has-client-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'Manage');echo " "; echo Yii::t('tx', 'Competence Has Clients'); ?></h2>
        ...
        <div class="col-md-12">
            ...
            <?php $this->widget('bootstrap.widgets.TbGridView',array(
                ...
                'columns'=>array(
					...
					array(
			        'name'=>'competence_id',
			        'value'=>'($data->competence->name)',
			        'type'=>'raw',
                    'filter' =>CHtml::listData(Competence::model()->findAll(), 'id', 'name'),
                    ...
                    array(
                        ...
                        'buttons'=>array
                        (
                            'delete' => array('visible'=>'Yii::app()->user->checkAccess(\'competencehasclient.delete\')'),
                            'update' => array('visible'=>'Yii::app()->user->checkAccess(\'competencehasclient.update\')'),
                            'view' => array('visible'=>'Yii::app()->user->checkAccess(\'competencehasclient.view\')'),
                        ),
                ),
                ),
            )); ?>
            ...
            <?php if(Yii::app()->user->checkAccess('competencehasclient.ajaxupdate')): ?>
            <div class="actions">
