...
$tt= "$('#competence-btn').click(function() { var btn = $(this); btn.html('".$btn_txt."'); });" ;
...
?><?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="form-group">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12">
		<?php echo $form->textArea($model,'description',array('class' => 'form-control', 'rows'=>'3', 'placeholder'=>''  )); ?>
    ...
    <div class="form-group">
        <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
            ...
            <?php $this->widget('bootstrap.widgets.TbButton', array(
                ...
                'htmlOptions' => array('id' => 'competence-btn', 'class' => 'lightslategrey')
		    )); ?>
        </div>
    </div>
