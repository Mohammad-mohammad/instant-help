...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('competence-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
<div class="x_title">
    <h2><?php echo Yii::t('tx', 'Manage');echo " "; echo Yii::t('tx', 'Competences'); ?></h2>
        ...
        <div class="col-md-12">
            ...
            <?php $this->widget('bootstrap.widgets.TbGridView',array(
                ...
                'columns'=>array(
					...
					array(
                        'name' => 'description',
                        'value' => 'Helpers::contentHelper($data->description,40)',
                    ),
                    array(
                        'class'=>'CButtonColumn',
                        ...
                        'buttons'=>array
                        (
                            'delete' => array('visible'=>'Yii::app()->user->checkAccess(\'competence.delete\')'),
                            'update' => array('visible'=>'Yii::app()->user->checkAccess(\'competence.update\')'),
                            'view' => array('visible'=>'Yii::app()->user->checkAccess(\'competence.view\')'),
                        ),
                ),
                ),
            )); ?>
            ...
            <?php if(Yii::app()->user->checkAccess('competence.ajaxupdate')): ?>
            <div class="actions">
